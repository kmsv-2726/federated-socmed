...
import { getUserProfile, searchUsers, followUser, unfollowUser, checkFollowStatus, getMyFollowers, getMyFollowing, getAllProfiles, resetPassword, updateProfile, deleteAccount, getSuspendedUsers, unsuspendUser } from '../controllers/userController.js';

const router = express.Router();

router.get("/", verifyToken, getAllProfiles);
router.get("/search", verifyToken, searchUsers);
router.get("/suspended", verifyToken, verifyAdmin, getSuspendedUsers);
...
router.put("/:federatedId/unsuspend", verifyToken, verifyAdmin, unsuspendUser);
